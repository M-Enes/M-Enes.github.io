...
function changeLang(){
    if (htmlEl.lang === "en")
    {
        ...
        cardBodies.item(3).innerHTML = "Node.js bir JavaScript çalışma zamanıdır. Node.js ve TypeScript ile projeler yapıyorum.";
        ...
        cardBodies.item(3).innerHTML = "Node.js is a Javascript runtime. I make a projects with Node.js and TypeScript.";
